class ReadOneNotificationResponse {
  ...
  ReadOneNotificationResponse({this.data});

  ReadOneNotificationResponse copyWith({ReadOneNotificationModel? data}) =>
      ReadOneNotificationResponse(data: data ?? this.data);
...
class DataData {
  ...
  DataData({this.id, this.type, this.status});

  DataData copyWith({int? id, String? type, String? status}) => DataData(
        id: id ?? this.id,
        type: type ?? this.type,
  ...
  factory DataData.fromJson(Map<String, dynamic> json) =>
      DataData(id: json["id"], type: json["type"], status: json["status"]);
