              ...
              children: [
                Container(
                  ...
                  child: CircularPercentIndicator(
                    ...
                    center: Text(
                      "${statistic?.accepted?.percent?.floor()}%",
                ...
                Container(
                  ...
                  child: CircularPercentIndicator(
                    ...
                    center: Text(
                      "${statistic?.onAWay?.percent?.floor()}%",
                      style: GoogleFonts.inter(color: AppStyle.black),
                    ),
                ...
                Container(
                  ...
                  child: CircularPercentIndicator(
                    ...
                    lineWidth: 8.r,
                    percent:
                        (statistic?.delivered?.percent?.floor() ?? 0) / 100,
                    center: Text(
                      "${statistic?.delivered?.percent?.floor()}%",
                      style: GoogleFonts.inter(color: AppStyle.black),
                    ),
                ...
                Container(
                  ...
                  child: CircularPercentIndicator(
                    ...
                    center: Text(
                      "${statistic?.canceled?.percent?.floor()}%",
                      style: GoogleFonts.inter(color: AppStyle.black),
                    ),
