...
class _EditShopState extends ConsumerState<EditShop> {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScaffold(
      body: (colors) => Padding(
        padding: REdgeInsets.only(left: 18, top: 24, bottom: 18, right: 18),
        child: Container(
                      ...
                      children: [
                              ...
                              child: Column(
                                children: [
                                  CustomEditWidget(
                                    ...
                                    radius: 16,
                                    image: state.editShopData?.logoImg ?? "",
                                    imagePath: state.logoImagePath,
                                    isEmptyorNot: state.logoImagePath.isEmpty,
                                    isEmptyorNot2:
                                  ...
                                  8.verticalSpace,
                                  Text(
                                    AppHelpers.getTranslation(TrKeys.logoImage),
                                  ),
                                ],
                              ),
                            ),
                              ...
                              child: Column(
                                children: [
                                  CustomEditWidget(
                                    ...
                                    radius: 16,
                                    image:
                                        state.editShopData?.backgroundImg ?? "",
                                    imagePath: state.backImagePath,
                                    isEmptyorNot: state.backImagePath.isEmpty,
                                    isEmptyorNot2:
                                        state.backImagePath.isNotEmpty,
                                    localStoreImage:
                                        state.editShopData?.backgroundImg ?? "",
                                    onthisTap: () {
                                      notifier.getPhoto(context: context);
                                    },
                                  ),
                                  8.verticalSpace,
                                  Text(
                            ...
                            Expanded(
                              child: Column(
                                children: [
                                  ...
                                  OutlinedBorderTextField(
                                    validator: AppValidators.emptyCheck,
                                    initialText: state.editShopData?.phone,
                                    label: AppHelpers.getTranslation(
                                      TrKeys.phone,
                                    ),
                        ...
                        Row(
                          children: [
                            ...
                            const Spacer(),
                            ConfirmButton(
                              title: AppHelpers.getTranslation(TrKeys.editMap),
                              onTap: () {
                                showDialog(
                                  context: context,
                                  builder: (context) {
                              ...
                              child: Column(
                                children: [
                                  ...
                                  OutlinedBorderTextField(
                                    ...
                                    validator: AppValidators.emptyCheck,
                                    initialText: "${state.editShopData?.tax}",
                                    label: AppHelpers.getTranslation(
                                      TrKeys.tax,
                                    ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  OutlinedBorderTextField(
                                    ...
                                    validator: AppValidators.emptyCheck,
                                    initialText: state.editShopData?.minAmount
                                        .toString(),
                                    label: AppHelpers.getTranslation(
                                      TrKeys.minAmount,
                                    ),
