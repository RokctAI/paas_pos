...
$AcceptedOrdersStateCopyWith<AcceptedOrdersState> get copyWith => _$AcceptedOrdersStateCopyWithImpl<AcceptedOrdersState>(this as AcceptedOrdersState, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AcceptedOrdersState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.hasMore, hasMore) || other.hasMore == hasMore)&&const DeepCollectionEquality().equals(other.orders, orders)&&(identical(other.totalCount, totalCount) || other.totalCount == totalCount)&&(identical(other.query, query) || other.query == query));
}
...
/// @nodoc
abstract mixin class $AcceptedOrdersStateCopyWith<$Res>  {
  factory $AcceptedOrdersStateCopyWith(AcceptedOrdersState value, $Res Function(AcceptedOrdersState) _then) = _$AcceptedOrdersStateCopyWithImpl;
@useResult
$Res call({
...
class _$AcceptedOrdersStateCopyWithImpl<$Res>
  ...
  _$AcceptedOrdersStateCopyWithImpl(this._self, this._then);

  final AcceptedOrdersState _self;
...
/// Adds pattern-matching-related methods to [AcceptedOrdersState].
extension AcceptedOrdersStatePatterns on AcceptedOrdersState {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AcceptedOrdersState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AcceptedOrdersState() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AcceptedOrdersState value)  $default,){
final _that = this;
switch (_that) {
case _AcceptedOrdersState():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AcceptedOrdersState value)?  $default,){
final _that = this;
switch (_that) {
case _AcceptedOrdersState() when $default != null:
return $default(_that);case _:
...
class _AcceptedOrdersState extends AcceptedOrdersState {
  const _AcceptedOrdersState({this.isLoading = false, this.hasMore = true, final  List<OrderData> orders = const [], this.totalCount = 0, this.query = ''}): _orders = orders,super._();
...
@pragma('vm:prefer-inline')
_$AcceptedOrdersStateCopyWith<_AcceptedOrdersState> get copyWith => __$AcceptedOrdersStateCopyWithImpl<_AcceptedOrdersState>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AcceptedOrdersState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.hasMore, hasMore) || other.hasMore == hasMore)&&const DeepCollectionEquality().equals(other._orders, _orders)&&(identical(other.totalCount, totalCount) || other.totalCount == totalCount)&&(identical(other.query, query) || other.query == query));
}
...
/// @nodoc
abstract mixin class _$AcceptedOrdersStateCopyWith<$Res> implements $AcceptedOrdersStateCopyWith<$Res> {
  factory _$AcceptedOrdersStateCopyWith(_AcceptedOrdersState value, $Res Function(_AcceptedOrdersState) _then) = __$AcceptedOrdersStateCopyWithImpl;
@override @useResult
$Res call({
 bool isLoading, bool hasMore, List<OrderData> orders, int totalCount, String query
});
...
/// @nodoc
class __$AcceptedOrdersStateCopyWithImpl<$Res>
    implements _$AcceptedOrdersStateCopyWith<$Res> {
  __$AcceptedOrdersStateCopyWithImpl(this._self, this._then);

  final _AcceptedOrdersState _self;
  final $Res Function(_AcceptedOrdersState) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? isLoading = null,Object? hasMore = null,Object? orders = null,Object? totalCount = null,Object? query = null,}) {
  return _then(_AcceptedOrdersState(
isLoading: null == isLoading ? _self.isLoading : isLoading // ignore: cast_nullable_to_non_nullable
as bool,hasMore: null == hasMore ? _self.hasMore : hasMore // ignore: cast_nullable_to_non_nullable
