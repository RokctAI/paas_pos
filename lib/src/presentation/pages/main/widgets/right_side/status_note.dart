...
class StatusNoteDialog extends ConsumerStatefulWidget {
  const StatusNoteDialog({super.key});

  @override
  ConsumerState<StatusNoteDialog> createState() => _NoteDialogState();
}

class _NoteDialogState extends ConsumerState<StatusNoteDialog> {
  @override
      ...
      child: Column(
        ...
        children: [
          ...
          OutlinedBorderTextField(
            maxLine: 3,
            onChanged: notifier.setStatusNote,
